...
public class EgovExcelServiceMapper extends EgovAbstractMapper {
    ...
    /**
     * <pre>
     * 개요 : insertMktTargetList 인서트
     * </pre>
     * @Method Name : batchInsertSelect
     * @author : dgu
     * @date : 2018. 10. 20.
     * @param queryId
     * @param list
     * @return
     */ 	
    public Integer batchInsertSelect(String queryId, List<TrgetSlctnRegistVO> list) {
        Iterator<TrgetSlctnRegistVO> itr = list.iterator();
    ...
    public Integer batchInsert(String queryId, List<TrgetSlctnExcelRegistVO> list) {
        Iterator<TrgetSlctnExcelRegistVO> itr = list.iterator();
     ...
     * @return
     */
	public Integer batchInsert(final String queryId, final List<TrgetSlctnExcelRegistVO> list, final int start) {
		int count = 0;
